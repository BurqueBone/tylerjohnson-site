export type CaseStudy = {
  id: string;
  title: string;
  tagline?: string; // shown muted, immediately under the title
  body: string[];
  tools: string[];
};
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    body: [
      "Outbound SDRs were working stale leads with no visibility into who'd been touched, by whom, when, or whether the last touch got a response. Average time-to-first-response was over 30 days.",
    ...
    tools: ["HubSpot Forms", "Salesforce Flows", "Slack", "Salesforce Dashboard"],
  },
  {
    id: "icp-lead-scoring",
    title: "ICP Analysis & Lead Scoring",
    tagline: "A/B/C/D/U tiered model grounded in climate-credible data",
    body: [
    ...
    tools: ["Salesforce", "ZoomInfo", "MSCI ESG data", "CDP disclosure data", "Coefficient"],
  },
  {
    id: "two-touch-attribution",
    title: "Two Touch Attribution",
    tagline: "75% of \"outbound\" SQOs were actually marketing-sourced",
    body: [
      "The attribution model was Sales vs Marketing tug-of-war. Every SQO got claimed as \"outbound\" because the SDR was the last human touch. Marketing had no defense and no way to prove what their spend was actually doing.",
    ...
    tools: ["HubSpot Forms", "Salesforce Flows", "Coefficient", "Salesforce Dashboard"],
  },
  {
    id: "retire-the-mql",
    title: "Retire the MQL → Track the Signals",
    tagline: "Dual-funnel measurement system replacing MQL with Qualification Signals",
    body: [
      ...
      "Two Touch Attribution generalizes here: qualification is a stream of typed, timestamped signals, not a one-time gate. The funnel stops lying about which motion is actually working.",
    ],
    tools: ["Salesforce Flows", "Coefficient", "Salesforce Dashboard"],
  },
];
